...
\begin{table}[h!]
  \centering
  \captionof{table}{Computer Specification}
  \label{tbl:specs}
 ...
 \verb|labels.json| on each part of the data. The label JSON structure is shown in Figure \ref{fig:labelstructure}.
  ...
  \begin{figure}
    ...
    \begin{subfigure}[][][t]{.57\textwidth}
      \fbox{\includegraphics[width=.99\linewidth]{figures/filestructure.png}}
      \label{fig:filestructure}
      \caption{Dataset File Structure}
    \end{subfigure}\hfill
    \begin{subfigure}[][][t]{.37\textwidth}
      \fbox{\includegraphics[width=.99\linewidth]{figures/labelstructure.png}}
