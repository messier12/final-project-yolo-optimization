...
\label{section:relatedwork}
  ...
  YOLO-Z modified the backbone, neck, and number of anchors of the original YOLOv5 to 
  enhance its capability of detecting small objects \parencite{yoloz}.
  YOLO-Z changed backbone of YOLOv5r5.0 to a downscaled DenseNet.
  The neck was also changed from FPN to biFPN on some YOLO-Z scales.
