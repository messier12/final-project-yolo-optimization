...
\section{Problem Scope}
    ...
    \begin{itemize}[noitemsep,topsep=0pt]
        ...
        \item The modified YOLOv7 must be trainable with a reasonable duration using the computational resource
        available, that is a computer which uses consumer GPU Nvidia RTX 2080 Ti.
    \end{itemize}
